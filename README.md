...
- блок працівників з ролями Директор, Адміністратор, Продавець, Касир, картками працівників, зміною ролі працівника, редагуванням дозволів ролей галочками і приховуванням блоків/дій без дозволу;
- вхід працівника через окремий сеанс B2C замість перемикача в лівому меню; вхід, вихід і невдалий PIN пишуться в журнал дій;
...
- Поточний build для продовження: `20260606-b2c-login-session`.
